...
import OBR, { buildText } from "./obr-sdk.js?v=31";
import { KEY, OBJ, CHILD, HPL, LABEL_GAP, LABEL_SIZE, hpVisibleTo, hpColour, pieceBox, sharedLabel } from "./common.js?v=31";
import { openCombatWindow } from "./pieces.js?v=31";
...
OBR.onReady(async () => {
  ...
  OBR.contextMenu.create({
    ...
    embed: { url: BASE + "use-image.html?v=31", height: 440 },
