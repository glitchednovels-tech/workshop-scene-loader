...
import OBR from "./obr-sdk.js?v=33";
import { OBJ, CHILD, SCENE, HP_VIS, DEFAULT_CONDITIONS, normKey, sortConditions, detectCondition, hpVisibleTo } from "./common.js?v=33";
import {
