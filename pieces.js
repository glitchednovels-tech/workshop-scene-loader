...
import OBR, { buildShape, buildText, buildImage } from "./obr-sdk.js?v=31";
import { OBJ, CHILD, ROLE, ROOM, LABEL_GAP, LABEL_SIZE, normKey, sortConditions, sharedLabel, pieceBox } from "./common.js?v=31";
...
export async function openCombatWindow(focus) {
  ...
  if (!already) {
    ...
    await OBR.popover.open({
      id: COMBAT_POPOVER, url: BASE + "combat.html?v=31", width: Math.min(500, vw - 40), height: Math.max(420, vh - 96),
