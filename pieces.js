...
import OBR, { buildShape, buildText, buildImage } from "./obr-sdk.js?v=22";
import { OBJ, CHILD, ROLE, ROOM, LABEL_GAP, LABEL_SIZE, normKey, sortConditions, sharedLabel, pieceBox } from "./common.js?v=22";
